    ...
    return (
        <main className={styles.home}>
            ...
            <section className={styles.side_nav}>
                <ul>
                    <li>
                        <NavLink className={({ isActive }) => isActive ? activeClassName : undefined} onClick={() => setNav(!nav)} to="Patronise">Patronise</NavLink>
                    </li>
                    <li>
                        <NavLink className={({ isActive }) => isActive ? activeClassName : undefined} onClick={() => setNav(!nav)} to="bid">Bid</NavLink>
                    </li>
                </ul>
